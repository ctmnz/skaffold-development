...
## project name. used for the project subdomain
project_name="app01"
...
openssl req -out tls-files/${project_name}.127.0.0.1.nip.io.csr -newkey rsa:2048 -nodes -keyout tls-files/${project_name}.127.0.0.1.nip.io.key -subj "/CN=${project_name}.127.0.0.1.nip.io/O=homecluster organization"
openssl x509 -req -sha256 -days 365 -CA tls-files/nip.io.crt -CAkey tls-files/nip.io.key -set_serial 0 -in tls-files/${project_name}.127.0.0.1.nip.io.csr -out tls-files/${project_name}.127.0.0.1.nip.io.crt
